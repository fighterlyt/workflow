...
type IdGenerator interface {
	Generate(entityType def.EntityType) string
}
...
func Generate(entityType def.EntityType) string {
	if idGenerator == nil {
		SetIdGenerator(newObjectIdGenerator())
	}
	return idGenerator.Generate(entityType)
}
...
func (o *objectIdGenerator) Generate(entityType def.EntityType) string {
	var b [12]byte
